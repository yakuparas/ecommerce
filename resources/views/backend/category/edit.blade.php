        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item"><a href="{{ route('admin.category.create') }}">Kategori Ekle</a></div>
                </div>
            </div>
                                ...
                                <form method="POST" action="{{ route('admin.category.update', [ 'id'=> $data->id ]) }}"
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <input name="title" type="text" value="{{$data->title}}" id="title" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                    ...
                                    <div class="form-group row mb-4">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Anahtar
                                            Kelime</label>
                                        <div class="col-sm-12 col-md-7">
                                            <input type="text" value="{{$data->keywords}}" name="keywords" class="form-control inputtags">
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Seo URL</label>
                                        <div class="col-sm-12 col-md-7">
                                            <input type="text" name="seourl" value="{{$data->seo_url}}" id="seourl" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <select name="status" class="form-control selectric">
                                                <option value="1" @if (1 == $data->status)
                                                    selected="selected"
                                                @endif>Aktif
                                               </option>

                                               <option value="0" @if (0 == $data->status)
                                                selected="selected"
                                            @endif>Pasif
                                           </option>
