...
@section('title', 'Seçenek Güncelleme')
@section('css')
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="POST" action="{{ route('admin.variants.update',['id'=>$data[0]['id']]) }}"
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <input name="title" value="{{$data[0]['name']}}" type="text" id="title" class="form-control">
                                        </div>
                                    </div>
                                    <hr>
                                             ...
                                             <div class="row d-flex align-items-end">
                                                 ...
                                                 <div class="col-md-2 col-12">
                                                     <div class="form-group">
                                                         ...
                                                         <input type="text" value="{{$r->name}}"  id="itemname" name="name"
                                                             class="form-control" />
                                                 ...
                                                 <div class="col-md-2 col-12">
                                                     <div class="form-group">                                                            
                                                         <div class="preview">
                                                             ...
                                                             <img width="100px" src="{{$r->image}}" name="file-ip-1-preview" id="file-ip-1-preview">
                                                           </div>                                                        </div>
                                                 </div>
                                                 ...
                                                 <div class="col-md-2 col-12">
                                                     <div class="form-group">
                                                         <button
                                                             ...
                                                             <span>Sil</span>
                                                             <input type="hidden" value="{{$r->id}}" name="oid">
                                                ...
                                                <div class="col-md-2 col-12">
                                                    <div class="form-group">                                                            
                                                        <div class="preview">
                                                            ...
                                                            <img width="100px" src="" name="file-ip-1-preview" id="file-ip-1-preview">
                                                          </div>                                                        </div>
                                                </div>
