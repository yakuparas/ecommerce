        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item"><a href="{{ route('admin.brands.list') }}">Üretici</a></div>
                    <div class="breadcrumb-item">Üretici Ekle</div>
                </div>
            </div>
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('admin.brands.store') }}"
                                    ...
                                    <div class="form-group row mb-4">
                                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Üretici
                                            Adı</label>
