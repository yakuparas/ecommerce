                                ...
                                <div class="slider-contain">
                                    <div>
                                        <div>
                                            ...
                                            <a href="{{$rs->url}}" class="btn btn-solid animated" data-animation-in="fadeInUp" data-delay-in="0.5">Devam</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
@section('content')
    ...
    <div class="title1 section-t-space">
        <h4>special offer</h4>
        <h2 class="title-inner1">Son Eklenen Ürünler</h2>
    </div>
    <div class="container">
        <div class="row">
    ...
    <section class="p-0">
        <div class="full-banner parallax text-center p-left">
            <img src="/frontend//assets/images/parallax/1.jpg" alt="" class="bg-img blur-up lazyload">
            <div class="container">
                <div class="row">
                    <div class="col">
